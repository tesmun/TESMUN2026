...
function VoxPopTeamPage({ team }: { team: 1 | 2 }) {
  ...
  const questionText = team === 1 ? (question === 1 ? "Describe TESMUN in one word." : "Why do students love TESMUN?") : (question === 1 ? "Q1. What is the most memorable thing about TESMUN 2026?" : "Q2. Which is your favourite committee and why?");
  return <section className="mt-14">
    <div className="mt-6 flex flex-wrap gap-3" role="tablist" aria-label={`Team ${team} questions`}><button type="button" role="tab" aria-selected={question === 1} onClick={() => setQuestion(1)} className={cn("border px-4 py-2 text-xs uppercase tracking-[0.14em]", question === 1 ? "border-gold bg-gold text-navy-deep" : "border-white/20 text-silver")}>Question 1</button><button type="button" role="tab" aria-selected={question === 2} onClick={() => setQuestion(2)} className={cn("border px-4 py-2 text-xs uppercase tracking-[0.14em]", question === 2 ? "border-gold bg-gold text-navy-deep" : "border-white/20 text-silver")}>Question 2</button></div>
    <div className="mt-10 border-t border-gold/30 pt-8"><p className="text-[11px] uppercase tracking-[0.18em] text-gold">Team {team}</p><h2 className="font-display mt-3 text-3xl sm:text-4xl">{questionText}</h2>
...
export default function PressSection() {
  ...
  {slug === "vox-pop" && <section className="mt-14 grid gap-6 sm:grid-cols-2"><Link to="/press/vox-pop-team-1" className="border border-white/10 bg-navy p-7 transition hover:border-gold"><p className="text-[11px] uppercase tracking-[0.18em] text-gold">Team 1</p><h2 className="font-display mt-3 text-3xl">One word, one reason</h2><p className="mt-3 text-sm leading-6 text-silver/80">Describe TESMUN in one word and tell us why students love it.</p></Link><Link to="/press/vox-pop-team-2" className="border border-white/10 bg-navy p-7 transition hover:border-gold"><p className="text-[11px] uppercase tracking-[0.18em] text-gold">Team 2</p><h2 className="font-display mt-3 text-3xl">Memories and committees</h2><p className="mt-3 text-sm leading-6 text-silver/80">The most memorable thing about TESMUN 2026 and favourite committees.</p></Link></section>}
  {slug === "vox-pop-team-1" && <VoxPopTeamPage team={1} />}
  {slug === "vox-pop-team-2" && <VoxPopTeamPage team={2} />}
