...
export default function Gallery() {
  ...
  return <main className="bg-warm">
    ...
    {active !== null && <div className="fixed inset-0 z-[80] flex items-center justify-center bg-navy-deep/95 p-6" onClick={() => setActive(null)}><button type="button" aria-label="Close photograph" className="absolute right-6 top-6 text-warm"><X size={28} /></button><img src={active.src} alt={active.alt} className="max-h-[82vh] max-w-5xl object-contain" /></div>}
  </main>;
}
